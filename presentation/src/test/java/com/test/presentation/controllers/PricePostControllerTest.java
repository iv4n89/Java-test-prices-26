...
public class PricePostControllerTest {
    ...
    void testRequestOn14thJune10AM() {
        ...
        PriceFinderRequest request = new PriceFinderRequest(1L, 35455L, LocalDateTime.of(2020, 6, 14, 10, 0, 0));
    ...
    void testRequestOn14thJune16PM() {
        // Given
        PriceFinderRequest request = new PriceFinderRequest(1L, 35455L, LocalDateTime.of(2020, 6, 14, 16, 0, 0));
    ...
    void testRequestOn14thJune21PM() {
        // Given
        PriceFinderRequest request = new PriceFinderRequest(1L, 35455L, LocalDateTime.of(2020, 6, 14, 21, 0, 0));
        Long expectedPriceList = 1L;
        Long expectedBrandId = 1L;
        Long expectedProductId = 35455L;
        String expectedPrice = "35.50 EUR";
    ...
    void testRequestOn15thJune10AM() {
        // Given
        PriceFinderRequest request = new PriceFinderRequest(1L, 35455L, LocalDateTime.of(2020, 6, 15, 10, 0, 0));
    ...
    void testRequestOn16thJune21PM() {
        // Given
        PriceFinderRequest request = new PriceFinderRequest(1L, 35455L, LocalDateTime.of(2020, 6, 16, 21, 0, 0));
    ...
    void testRequestNotFound() {
        // Given
        PriceFinderRequest request = new PriceFinderRequest(1L, 35455L, LocalDateTime.of(2021, 6, 16, 21, 0, 0));
